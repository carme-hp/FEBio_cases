...
if variables.paraview_output:
  ...
  variables.output_writer_fibers.append({"format": "Paraview", "outputInterval": variables.output_timestep, "filename": "out/fibers", "binary": True, "fixedFormat": False, "combineFiles": True, "fileNumbering": "incremental"})
...
for x in range(mx):
    for y in range(my):
        variables.elasticity_dirichlet_bc[(mz-1)*mx*my + x + y*mx] = [0.0, 0.0, 0.0, None, None, None]
