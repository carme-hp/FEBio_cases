...
fiber_file = input_directory + "/left_biceps_brachii_tendon1.bin"        # bottom tendon
...
config_hyperelasticity = {    # for both "HyperelasticitySolver" and "DynamicHyperelasticitySolver"
  ...
  "materialParameters":         variables.tendon_material_parameters,  # material parameters of the Mooney-Rivlin material
