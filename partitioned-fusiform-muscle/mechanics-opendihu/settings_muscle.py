...
config = {
  ...
  "logFormat":                      "csv",
  "mappingsBetweenMeshesLogFile":   "results/" + "muscle_mappings_between_meshes_log.txt",
  "solverStructureDiagramFile":     "results/" + "muscle_solver_structure_diagram.txt",
  ...
  "PreciceAdapter": {
    ...
    "MuscleContractionSolver": {
      ...
      "DynamicHyperelasticitySolver": { 
        ...
        "dirichletOutputFilename":    "results/" + "/muscle_dirichlet_output",
        "residualNormLogFilename":    "results/" + "/muscle_residual_norm_log.txt",
        "totalForceLogFilename":      "results/" + "/muscle_total_force_log.txt",
